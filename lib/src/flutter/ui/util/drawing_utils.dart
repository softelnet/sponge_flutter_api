...
class DrawingUtils {
  ...
  static Future<Uint8List> convertDrawingToPng(DrawingBinaryValue binaryValue,
  ...
  static Future<String> convertImageToPngBase64(
    ...
    return await compute(encodeImageToPngBase64, bytes);
  }
}
